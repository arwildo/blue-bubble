      ...
      return(
        <div className="col-span-4 sm:col-span-4 md:col-span-2 lg:col-span-1 xl:col-span-1 flex flex-col" key={item.title} data-aos="fade-up" data-aos-delay="250">
          ...
          <div className="group relative">
            <img src={"images/" + item.img} className="rounded-md shadow" alt={item.title} />
            <div className="absolute bg-black rounded hover:bg-opacity-25 bg-opacity-0 w-full h-full top-0 flex transition duration-500 ease-in-out">
              ...
              <div className="m-auto grid">
                <a href={item.live} className="shadow w-48 h-12 m-2 bg-white hover:bg-gray-200 btn-sm text-blue-500 opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition" target="_blank" rel="noopener noreferrer">
                  Live Demo <FaDesktop className="ml-2" />
                </a>

                <a href={item.get} className="shadow w-48 h-12 m-2 bg-blue-500 hover:bg-blue-600 btn-sm text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition" target="_blank" rel="noopener noreferrer">
          ...
          <div className="p-5">
            <div className="flex">
              <img className="w-6 h-6 mr-4" src={"images/" + item.icon} alt={item.title + " Icon"} />
