        ...
        <div className="flex flex-col items-center justify-between mt-6 md:flex-row">
          <div>
            <a href="https://arwildo.com" className="text-xl font-bold">
              <img className="w-8" src="images/logo.svg" alt="Arwildo" />
            </a>
          </div>
          <div className="-mx-4">
            <div className="flex mt-4 md:m-0">
              ...
              <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                <li>
                  <a href="https://twitter.com/arwildo" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter" data-aos="zoom-y-out" data-aos-delay="50">
                ...
                <li className="ml-4">
                  <a href="https://dribbble.com/arwildo" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Dribbble" data-aos="zoom-y-out" data-aos-delay="350">
